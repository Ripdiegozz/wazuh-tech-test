...
describe("TodosApiService", () => {
  ...
  describe("createTodo", () => {
    ...
    it("should throw error when create fails", async () => {
      ...
      await expect(
        service.createTodo({ title: "Test", priority: TodoPriority.LOW })
  ...
  describe("getTodoById", () => {
    ...
    it("should throw default error when no message provided", async () => {
      ...
      await expect(service.getTodoById("123")).rejects.toThrow(
        "TODO not found"
      );
    });
  });
  ...
  describe("updateTodo", () => {
    ...
    it("should throw error when update fails", async () => {
      ...
      await expect(
        service.updateTodo("123", { title: "Updated" })
  ...
  describe("archiveTodo", () => {
    it("should archive a todo successfully", async () => {
      ...
      expect(mockHttp.post).toHaveBeenCalledWith(
        "/api/custom_plugin/todos/123/archive"
      );
    ...
    it("should throw error when archive fails", async () => {
      ...
      await expect(service.archiveTodo("123")).rejects.toThrow(
        "Archive failed"
      );
    });
  });
  ...
  describe("restoreTodo", () => {
    it("should restore a todo successfully", async () => {
      ...
      expect(mockHttp.post).toHaveBeenCalledWith(
        "/api/custom_plugin/todos/123/restore"
      );
    ...
    it("should throw error when restore fails", async () => {
      ...
      await expect(service.restoreTodo("123")).rejects.toThrow(
        "Restore failed"
      );
    });
  });
  ...
  describe("bulk operations", () => {
    describe("bulkArchive", () => {
      ...
      it("should throw error when bulk archive fails", async () => {
        ...
        await expect(service.bulkArchive(["1"])).rejects.toThrow(
          "Failed to bulk archive TODOs"
        );
      });
    });
    ...
    describe("bulkRestore", () => {
      ...
      it("should throw error when bulk restore fails", async () => {
        mockHttp.post.mockResolvedValue({
          success: false,
          message: "Bulk restore error",
        });

        await expect(service.bulkRestore(["1"])).rejects.toThrow(
          "Bulk restore error"
        );
      });
    });
    ...
    describe("bulkDelete", () => {
      ...
      it("should throw error when bulk delete fails", async () => {
        ...
        await expect(service.bulkDelete(["1"])).rejects.toThrow(
